...
| Discovery | OpenAlex-backed "related/citing papers" and topic-based research trends computed from the library's own topic distribution, with no manual interest selection. |
